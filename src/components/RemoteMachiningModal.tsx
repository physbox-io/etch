        ...
        <div className="p-6 flex-1 overflow-y-auto space-y-4">
          ...
          {!isProAccount() ? (
            <div className="text-center py-10 bg-slate-50 dark:bg-slate-950/40 rounded-xl border border-slate-200 dark:border-slate-800 px-6">
              <Star className="w-10 h-10 text-indigo-500 mx-auto mb-3" />
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-block mt-4 px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg font-bold text-xs"
              >
                See PhysBox Pro
              </a>
            </div>
                ...
                <div key={idx} className="bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800/80 rounded-xl p-5 shadow-sm space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Device ID: <code className="text-indigo-600 dark:text-indigo-300">{item.deviceId || 'Primary CNC'}</code></p>
                    </div>
